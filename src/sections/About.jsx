      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center gap-5">
            <img src={aboutIcon} alt="Tentang Kami" className="h-[14px] xl:h-25 text-primary" />
        ...
        <div className="flex flex-col-reverse xl:flex-row gap-25 xl:gap-60 mt-25 xl:mt-30">
          
          {/* Left Text */}
          <div className="flex-2 max-w-[710px] space-y-4 xl:space-y-6 text-b5 xl:text-b2">
            <p>
