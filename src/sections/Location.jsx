...
export default function Location() {
  return (
    <section id="location" className="w-full bg-bw3 text-bw8 py-60 px-25 md:py-120 md:px-120">
      
      {/* HEADER (FULL WIDTH) */}
      <div className="items-center text-center max-w-[1440px]">
        {/* Label */}
        <div className="flex gap-5 justify-center items-center">
          <img src={locIcon} alt="Lokasi" className="h-[14px] md:h-25 text-primary" />
      ...
      {/* Cards */}
      <div className="mt-25 md:mt-45 w-full h-[350px] md:h-[450px] overflow-hidden shadow-card">
        <iframe
